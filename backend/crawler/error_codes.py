...
# 说明映射
ERROR_MESSAGES = {
    E001_CARD_API_FAILED: "card API 请求失败",
    E002_VIDEO_COUNT_FAILED: "无法获取视频总数",
    E101_ARC_SEARCH_BLOCKED: "arc/search API 被风控拦截",
    E102_ARC_SEARCH_HTTP_ERR: "arc/search API HTTP 错误",
    E103_VIDEO_INCOMPLETE: "视频列表不完整",
    E104_NO_VIDEOS_AT_ALL: "未获取到任何视频数据",
    E105_NO_LOGIN_COOKIE: "未加载登录 cookie",
